# Operator Quickstart — Community Passenger Ferry Operations

Shortest path from clone to a verified local dry-run for **ISIC 5011** (`cloud-itonami-isic-5011`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-5011.git
cd cloud-itonami-isic-5011
```
...
- Blueprint governor key: `maritime-safety-governor`
- Likely source path: `src/**/maritime-safety-governor.cljc`
