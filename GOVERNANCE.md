...
`cloud-itonami-5011` is an OSS open-business blueprint for community
passenger ferry operations, robotics-premised.

## Maintainers
Maintainers may merge changes that preserve these invariants:
- a robot action the governor refuses is never dispatched to hardware.
- the Maritime Safety Governor remains independent of the advisor.
- hard policy violations (out-of-certificate sailing, uninspected maintenance release, evidenceless reconciliation record) cannot be overridden by human approval.
